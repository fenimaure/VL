/**
 * Shared custom social media icons.
 * These replace the duplicated inline SVGs that were scattered across
 * Navbar, Footer, Sidebars, SocialShare, FloatingContact, and FooterManager.
 */
