...
export default function Navbar() {
  ...
  // Pick the correct logo asset based on scroll state and theme.
  // Not scrolled → dark pill background → always use light logo.
  // Scrolled → transparent/glass → use theme-appropriate logo.
